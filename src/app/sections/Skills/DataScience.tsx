const skills = ["Pandas", "Numpy", "Scikit-learn", "TensorFlow", "PyTorch", "LLMs", "CNN", "GAN", "Data Wrangling", "Feature Engineering", "Model Evaluation Techniques"];
...
export default function DataScience() {
  return (
    <div style={{ background: '#fffbe6', border: '1.5px solid #ffe066', borderRadius: 16, padding: 24, marginBottom: 24, boxShadow: '0 2px 8px 0 rgba(255, 217, 102, 0.08)' }}>
      <h3 style={{ margin: 0, color: '#b38b00' }}>Data Science</h3>
